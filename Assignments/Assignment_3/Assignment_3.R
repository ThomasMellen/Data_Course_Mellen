...
even_rows_iris <- iris[seq(2,150,2), ]
ls()
dim(even_rows_iris)
...
iris_chr <- data.frame(lapply(even_rows_iris, as.character))
...
big_area_iris <- iris$Sepal.Area <- Sepal.Area
#this stuff is starting to make more sense around here. i can see the pattern for naming new things and how to reference files in R
